<# 
Requires the following older modules:
https://www.powershellgallery.com/packages/Az.Resources/2.5.0
https://www.powershellgallery.com/packages/Az.Accounts/2.5.1
#>
...
# Connect to Azure with System Managed Identity
...
# Retrieve Workspace Primary Key
$sharedKey = Get-AutomationVariable -Name 'WorkspacePrimaryKey'
